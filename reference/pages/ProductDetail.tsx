      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="aspect-square rounded-2xl overflow-hidden border border-slate-100 cursor-pointer shadow-sm hover:border-primary transition-all">
              <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuADjrd5Q7OiLTLnv6yhAIyvg_AxWe26X-mkDyyzND8kl6gpVArZ9oDJDLixzWh1g38-cKhkIL9xM2XcignLBvWrfkVfgw-ZqJvPKIGqjuTCPdm08rukdL3PX2828YZI55uu0LRbmZr18fYeMHdWIVMMk1PvG5Fq1qaJsMWKyN6P_Mtcj4g_NycP9HxchguYVFUQpW9n44cxXDYJHsAYzByZqmtZMSOZ2vPHAxcVEZqn-Gp6T264rTLod_kX3UaUGZsdbQHZgtcIuIde" className="w-full h-full object-cover" />
            </div>
            <div className="aspect-square rounded-2xl overflow-hidden border border-slate-100 cursor-pointer shadow-sm hover:border-primary transition-all">
              <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBtBMUDwV57i2q5NZWVGKgTyKKvJHzAP8loKAuOsQHOHPtWSYnFiPxVH7nzUGU_Ue1VA-_XSmIy-01TxyxiCzKSWgEp6DSwuzNBVPeshfcPinvPsL0bJCoO-osURzLZzH2A8btrhvs5mJI6BMsv57dUz2axcVQbaNoPfQgymTGohzyswXPveDVUhGi4o7dQd5ZLVpWMaSfMD0sErgd5ZcvmW_T5gaOCHw41ZcayXhsPmtiLCoicENqD8AiSMeF5rIdaJ-3rSUEvPYM8" className="w-full h-full object-cover" />
            </div>
